...
1.  **Create a new C# script** called `Crate.cs`.
2.  Attach the script to the `Crate` prefab.
...
1.  **Create a new C# script** called `Enemy.cs`.
2.  Attach the script to the `Enemy` prefab.
3.  Implement the script as follows:
